...
#define __err_log(level,color,str, ...) fprintf_color(stderr,COLOR_CYAN,"VALIDATION_LAYER"); fprintf(stderr,"::["); fprintf_color(stderr,color,level); fprintf(stderr,"] "); fprintf(stderr,str __VA_OPT__(,) __VA_ARGS__)

/**
 * @brief a macro for printing debug
 */
#define debug(str, ...) __err_log("Verbose",COLOR_MAGENTA,str __VA_OPT__(,) __VA_ARGS__)

/**
 * @brief a macro for printing infos
 * 
 */
#define info( str, ... ) __err_log("Info",COLOR_GREEN,str __VA_OPT__(,) __VA_ARGS__)

/**
 * @brief a macro for printing warnings
 * 
 */
#define warning( str, ...) __err_log("Warning",COLOR_YELLOW,str __VA_OPT__(,) __VA_ARGS__)
